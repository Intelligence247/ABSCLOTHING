...
export default function AccessoriesCollectionPage() {
  ...
  const [selectedCollection, setSelectedCollection] = useState("Accessories")
  ...
  const accessoriesProducts = products.filter((p) => p.collection === "Accessories")
  ...
  const categories = ["All", ...Array.from(new Set(accessoriesProducts.map((p) => p.category)))]
