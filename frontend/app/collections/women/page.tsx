...
export default function WomenCollectionPage() {
  ...
  const [selectedCollection, setSelectedCollection] = useState("Women")
  ...
  const womenProducts = products.filter((p) => p.collection === "Women")
  ...
  const categories = ["All", ...Array.from(new Set(womenProducts.map((p) => p.category)))]
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-64 md:h-96 overflow-hidden bg-gradient-to-b from-primary/80 to-primary/40">
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
          ...
          >
            Explore our exquisite range of elegant women's fashion
          </motion.p>
        </div>
